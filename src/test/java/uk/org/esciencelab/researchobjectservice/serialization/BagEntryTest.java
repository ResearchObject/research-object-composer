...
public class BagEntryTest {
    ...
    private static RemoteResource inputEntry;
    private static RemoteResource workflowEntry;
    ...
    public void setUp() throws IOException {
        ...
        inputEntry = new RemoteResource("/input", input);
        JsonNode workflow = draftTaskContent.get("workflow");
        workflowEntry = new RemoteResource("/workflows/deep/folder", workflow);
    }
